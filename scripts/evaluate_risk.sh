...
sca_report="./.github/scripts/dependency-check-report/*.html"
sast_report="./.github/scripts/sonar-report/sonar-report.json"
dast_report="./.github/scripts/zap-report.html"
iast_report="./.github/scripts/iast-report"
